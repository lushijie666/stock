        ...
        with get_db_session() as session:
            ...
            paginate_dataframe(
                ...
                columns_config={
                    ...
                    'opening': st.column_config.NumberColumn('开盘', help="当日开盘价", format="%.2f"),
                    'closing': st.column_config.NumberColumn('收盘', help="当日收盘价", format="%.2f"),
                    'highest': st.column_config.NumberColumn('最高', help="当日最高价", format="%.2f"),
                    'lowest': st.column_config.NumberColumn('最低', help="当日最低价", format="%.2f"),
